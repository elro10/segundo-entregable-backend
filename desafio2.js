...
async function test() {
  ...
  await item.addProduct("abc123", "producto prueba", "Este es un producto prueba", 200, "Sin imagen", 25);
  await item.addProduct("abc456", "producto prueba", "Este es un producto prueba", 200, "Sin imagen", 25);
  await item.getProductById(1);
  await item.updateProdById(1, "title", "Este es un producto prueba actualizado");
  await item.getProductById(1);
